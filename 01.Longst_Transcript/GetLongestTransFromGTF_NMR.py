...
parser = argparse.ArgumentParser(usage="GetLongestTransFromGTF_NMR.py --gtffile Heterocephalus_glaber_female.Naked_mole-rat_maternal.110.chr.gtf.gz --genome Heterocephalus_glaber_female.Naked_mole-rat_maternal.dna.toplevel.fa --outfile longest_trans.fa",
